...
#------------Simplified 2 (logo on right side)-------------
  ...
  ######################Estimate Section#####################
  estimatesframe=Frame(tab3, relief=GROOVE, bg="#f8f8f2")
  estimatesframe.pack(side="top", fill=BOTH)
  
  esttframe=Frame(estimatesframe, bg="#f5f3f2")
  esttframe.pack(side="top", fill=X)
  
  # #create new order

  def estimate_create():
    estimate_pop=Toplevel(midFrame)
    ...
    def estimate_custom():
      ...
      def estimate_create1():
        estimate_ven=Toplevel(midFrame)
        ...
        estimate_checkbtn1=Checkbutton(estimate_labelframe1,text="Active",variable=checkvar1,onvalue=1,offvalue=0,bg="#f5f3f2").place(x=760 ,y=10)
    ...
    cost1=Label(estimate_labelfram1,text="Extra cost name").place(x=2,y=5)
    e1=ttk.Combobox(estimate_labelfram1, value="",width=20).place(x=115,y=5)
    rate=Label(estimate_labelfram1,text="Discount rate").place(x=370,y=5)
    e2=Entry(estimate_labelfram1,width=6).place(x=460,y=5)
    cost2=Label(estimate_labelfram1,text="Extra cost").place(x=35,y=35)
    e3=Entry(estimate_labelfram1,width=10).place(x=115,y=35)
    tax=Label(estimate_labelfram1,text="Tax1").place(x=420,y=35)
    e4=Entry(estimate_labelfram1,width=7).place(x=460,y=35)
    template=Label(estimate_labelfram1,text="Template").place(x=37,y=70)
    e5=ttk.Combobox(estimate_labelfram1, value="",width=25).place(x=115,y=70)
    sales=Label(estimate_labelfram1,text="Sales Person").place(x=25,y=100)
    e6=Entry(estimate_labelfram1,width=18).place(x=115,y=100)
    category=Label(estimate_labelfram1,text="Category").place(x=300,y=100)
    e7=Entry(estimate_labelfram1,width=22).place(x=370,y=100)
    
    statusfrme = LabelFrame(estimate_labelfram1,text="Status",font=("arial",15))
    ...
    text1=Label(estimate_headerFrame,text="Title text").place(x=50,y=5)
    e1=ttk.Combobox(estimate_headerFrame, value="",width=60).place(x=125,y=5)
    text2=Label(estimate_headerFrame,text="Page header text").place(x=2,y=45)
    e1=ttk.Combobox(estimate_headerFrame, value="",width=60).place(x=125,y=45)
    text3=Label(estimate_headerFrame,text="Footer text").place(x=35,y=85)
    e1=ttk.Combobox(estimate_headerFrame, value="",width=60).place(x=125,y=85)

    text=Label(estimate_noteFrame,text="Private notes(not shown on invoice/order/estemates)").place(x=10,y=10)
    e1=Text(estimate_noteFrame,width=100,height=7).place(x=10,y=32)

    e1=Text(estimate_termsFrame,width=100,height=9).place(x=10,y=10)

    e1=Text(estimate_commentFrame,width=100,height=9).place(x=10,y=10)

    btn1=Button(estimate_documentFrame,height=2,width=3,text="+").place(x=5,y=10)
    btn2=Button(estimate_documentFrame,height=2,width=3,text="-").place(x=5,y=50)
    text=Label(estimate_documentFrame,text="Attached documents or image files.If you attach large email then email taken long time to send").place(x=50,y=10)
    cusventtree=ttk.Treeview(estimate_documentFrame, height=5)
    ...
    fir4Frame=Frame(estimate_pop,height=190,width=210,bg="#f5f3f2")
    ...
    fir5Frame=Frame(estimate_pop,height=38,width=210)
